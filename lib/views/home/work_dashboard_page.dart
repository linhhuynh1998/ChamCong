...
class WorkDashboardPage extends StatelessWidget {
        ...
        child: ListView(
          ...
          children: [
            ...
            GridView.count(
              ...
              children: const [
                _StatTile(value: '0', label: 'Đã Vào', color: Color(0xFF5B9A24)),
                _StatTile(value: '0', label: 'Đi Muộn', color: Color(0xFFA4222A)),
                _StatTile(value: '0', label: 'Đúng Giờ', color: Color(0xFF2B4B7A)),
                _StatTile(value: '0', label: 'Chưa Vào', color: Color(0xFFE11A1A)),
                _StatTile(value: '0', label: 'Nghỉ Phép', color: Color(0xFFE6A65B)),
                _StatTile(value: '0', label: 'Chia Sẻ Vị Trí', color: Color(0xFF5D93EF)),
              ],
            ),
          ],
        ),
