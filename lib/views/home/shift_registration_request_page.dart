...
class ShiftRegistrationRequestPage extends StatefulWidget {
  const ShiftRegistrationRequestPage({super.key});

  @override
  State<ShiftRegistrationRequestPage> createState() => _ShiftRegistrationRequestPageState();
}

class _ShiftRegistrationRequestPageState extends State<ShiftRegistrationRequestPage> {
