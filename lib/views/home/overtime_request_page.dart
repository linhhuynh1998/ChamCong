    ...
    try {
      ...
      final message = await _requestsService.createRequest(
        ...
        fields: <String, dynamic>{
          ...
          if (_quantityController.text.trim().isNotEmpty) 'Số giờ': _quantityController.text.trim(),
          if (_ratioController.text.trim().isNotEmpty) 'Tỷ lệ': _ratioController.text.trim(),
