...
class BusinessTripOutRequestPage extends StatefulWidget {
  const BusinessTripOutRequestPage({super.key});

  @override
  State<BusinessTripOutRequestPage> createState() =>
      _BusinessTripOutRequestPageState();
}

class _BusinessTripOutRequestPageState
    extends State<BusinessTripOutRequestPage> {
  ...
  Future<void> _onSubmit() async {
    ...
    if (_locationController.text.trim().isEmpty) {
      AppNotice.showError(context, 'Vui lòng nhập địa điểm');
      return;
    }
